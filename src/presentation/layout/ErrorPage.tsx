...
export default function ErrorPage({
  ...
  return (
    <>
      ...
      <main className="grid min-h-screen place-items-center  px-6 py-24 sm:py-32 lg:px-8  bg-linear-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
