                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <Link
                                to={ROUTES.register}
                                className="bg-linear-to-r from-indigo-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-colors font-medium"
                            >
                                Commencer
                            </Link>
                        </div>
                    ...
                    <div className="md:hidden py-4 border-t border-gray-200 dark:border-gray-700">
                        <div className="space-y-4">
                            ...
                            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
                                ...
                                <Link
                                    to={ROUTES.register}
                                    className="block bg-linear-to-r from-indigo-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-colors font-medium text-center"
                                    onClick={() => setMobileMenuOpen(false)}
                                >
                                    Commencer
                                </Link>
