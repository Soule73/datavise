...
export default function DataTableSearch({
  ...
  return (
    <div className="flex w-full flex-wrap items-center gap-2 mb-2 sticky top-0 bg-white dark:bg-gray-900 px-2 py-1 border-b border-gray-200 dark:border-gray-700 justify-between">
      {name && (
